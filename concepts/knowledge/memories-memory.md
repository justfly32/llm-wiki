...
updated: 2026-06-12
type: concept
tags: [personal, memory, python, database, web]
sources: [raw/local/memory/memories-memory-2026-06-12.md]
source_file: /Users/bearj/.hermes/memories/MEMORY.md
confidence: high
links: [[memories-user|사용자 프로필]], [[docs-hermes_beginner_guide|Hermes 초보자 가이드]], [[docs-hermes_final_guide|Hermes 완벽 가이드]], [[docs-guide|Hermes 설치 가이드]]
---

# Memory

> 📁 원본: `/Users/bearj/.hermes/memories/MEMORY.md`
> 📅 수집: 2026-06-12
> 🏷️ 카테고리: memory
