...
| 폴더 | 설명 | remote | 최근 커밋 |
|------|------|--------|----------|
| `  post1` | - | justfly32/post1 | 2026-09-05 |
| `  auto-trading` | 한국 주식 자동매매 — Mock 가상매매 검증 → NH투자증권 모의투자 → 실전 전환 완료 (500만원). | - | 2026-09-02 |
...
| `  lotto-predictor` | 1231회차 전체 데이터 기반 번호별 확률 학습 예측 모델. | 15 |
