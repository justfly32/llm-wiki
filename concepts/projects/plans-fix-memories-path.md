---
title: Fix: daily_memories 기본 경로 수정
created: 2026-06-01
updated: 2026-06-01
type: concept
tags: [web, programming, python]
sources: [raw/local/web/plans-fix-memories-path-2026-06-01.md]
source_file: /Users/bearj/projects/post1/.omo/plans/fix-memories-path.md
confidence: high
links: [[plans-site-refinement|개인 사이트 자동화 고도화]], [[plans-web-terminal-plan|Web Terminal 계획]]
---

# Fix: daily_memories 기본 경로 수정

> 📁 원본: `/Users/bearj/projects/post1/.omo/plans/fix-memories-path.md`
> 📅 수집: 2026-06-01
> 🏷️ 카테고리: web
