...
updated: 2026-07-15
type: concept
tags: [research, ai-ml, programming, optimization, multimodal]
sources: [raw/papers/requential-coding-pushing-the-limits-of-model-compression-w-2026-07-15.md]
confidence: medium
---

# Requential Coding: Pushing the Limits of Model Compression with Self-Generated Training Data

> 📄 원문: [Requential Coding: Pushing the Limits of Model Compression with Self-Generated Training Data](https://arxiv.org/abs/2607.11883v1)
> ✍️ 저자: Shikai Qiu, Marc Finzi, Yujia Zheng
> 📅 발행: 2026-07-13
> 🏷️ 카테고리: cs.LG
...
- [arXiv 원문 보기](https://arxiv.org/abs/2607.11883v1)
